...
function update () {
    ...
    chronos[0].seconds -= 1;
    if (chronos[0].seconds < 0) {
        chronos[0].seconds = 59;
        chronos[0].minutes -= 1;
    }
    chronos[0].displayTime();
    if (chronos[0].minutes < 0) {
...
class chrono {
    ...
    constructor (name, duration) {
        ...
        this.minutes = duration;// * 60; // Le décrémentation se fait en seconde. et le display reconvertira dans l'autre sens et formatera le texte
        this.seconds = 0;
        ...
        this.displayTime = function () {
            ...
            document.getElementById("t_" + this.id).innerHTML = `${this.minutes}:${this.seconds}`;
        } 
        ...
        this.chrono_html = new chrono_html(this.id, this.name, this.duration);
